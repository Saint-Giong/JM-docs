...
<Columns cols={2}>
  <Card title="Job Applicant Subsystem" icon="user">
    Provides tools for career advancement, job search, and application
    management
  </Card>
  <Card title="Job Manager Subsystem" icon="building">
...
<Info>
**SGJM ↔ SGJA Collaboration**

Team SGJM (Saint Giong Job Manager) and Team SGJA (Saint Giong Job Applicant) work together within the Saint Giong Squad to deliver the complete DEVision platform.
...
<Warning>
  All teams must follow professional software development practices as outlined
  in the requirements.
</Warning>
...
<Info>
  This project is part of the Software Engineering curriculum at RMIT University
  and follows strict academic and professional standards.
</Info>
