...
Team Saint Giong is implementing the **Ultimo (Advanced)** architecture specification, featuring microservices backend, headless UI frontend, and event-driven communication.
...
<Steps>
  ...
  <Step title="Data Access Layer">
    Database entities and mappings
  </Step>
</Steps>
...
<Warning>
Each module maintains strict bounded context
</Warning>
...
<Tabs>
  <Tab title="External APIs">
    **Public Services** exposed via interfaces
    - Available to other modules
    - Defined contracts
    - Versioned endpoints
  </Tab>
  <Tab title="Internal APIs">
    **Private Services** used within module
...
<Tabs>
  ...
  <Tab title="Machine 3">
    **Backend Services (Set 1)**
    - Auth Service
    - Profile Service
    - Job Service
  </Tab>
  <Tab title="Machine 4">
    **Backend Services (Set 2)**
    - Search Service
...
<Tabs>
  ...
  <Tab title="DevOps">
    ...
    - **Gateway:** Kong or Spring Cloud Gateway
    - **Discovery:** Eureka
